...
class AcceptWorkAddressScreen extends StatefulWidget {
  @override
  _acceptWorkAddressScreenState createState() => _acceptWorkAddressScreenState();
}

class _acceptWorkAddressScreenState extends State<AcceptWorkAddressScreen> {
  @override
    ...
    MaterialApp(
      home: Scaffold(
        ...
        Column(
          ...
          Text(
            "Your work address has been updated!",
            textAlign: TextAlign.left,
                  style: TextStyle(
                    fontFamily: 'Poppins',
                    color: Colors.black,
