...
class AcceptEmailAddressScreen extends StatefulWidget {
  @override
  _acceptEmailAddressScreenState createState() => _acceptEmailAddressScreenState();
}

class _acceptEmailAddressScreenState extends State<AcceptEmailAddressScreen> {
  @override
