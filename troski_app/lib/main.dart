...
import 'package:troski_test/screens/accept_home_address_screen.dart';
...
import 'package:troski_test/screens/trip_help_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //   persistenceEnabled: true, // Enable local data persistence
    // );
    // return MultiProvider(
    //     providers: [ChangeNotifierProvider(create: (_) => AuthProvider())],
    //     child: MaterialApp(
    //       title: 'Flutter Truski ui',
    //       home: PhoneNumberScreen(),
    //       theme: ThemeData(
    //         colorScheme: ColorScheme.fromSeed(seedColor: Color(0xffFF8300)),
    //         useMaterial3: true,
    //       ),
    //     ));
    ...
    return MaterialApp(
      ...
      //home: AcceptWorkAddressScreen(),
      home: LandingPage(),
      //home: DeleteAccountScreen(),
      //home: HomePage(),
      // home: OtpScreen(),
      // home: SignUpPage(phoneNumber: '+233557187667'),
      // home: PhoneNumberScreen(),
      // home: MyHomePage(
      //   title: 'Test',
      // ),
      theme: ThemeData(
        ...
        // state is not lost during the reload. To reset the state, use hot j
        // restart instead.
        //
